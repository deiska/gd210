...
static struct s3c2410_uartcfg __initdata smdkv210_uartcfgs[]  = {
	[0] = {
		.hwport		= 0,
		.flags		= 0,
...
static struct s3c_ide_platdata __initdata smdkv210_ide_pdata  = {
	.setup_gpio	= s5pv210_ide_setup_gpio,
};

static uint32_t __initdata smdkv210_keymap[]  = {
	/* KEY(row, col, keycode) */
...
static struct matrix_keymap_data __initdata smdkv210_keymap_data  = {
	.keymap		= smdkv210_keymap,
	.keymap_size	= ARRAY_SIZE(smdkv210_keymap),
};

static struct samsung_keypad_platdata __initdata smdkv210_keypad_data  = {
...
static struct resource smdkv210_dm9000_resources[] = {
	[0] = {
		.start	= 0x88000000,//S5PV210_PA_SROM_BANK5,
		.end	= 0x88000000+3,//S5PV210_PA_SROM_BANK5,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= 0x88000000+4,//S5PV210_PA_SROM_BANK5 + 2,
		.end	= 0x88000000+4+3,//S5PV210_PA_SROM_BANK5 + 2,
		.flags	= IORESOURCE_MEM,
	},
	[2] = {
		.start	= IRQ_EINT(10),
...
static struct s3c_fb_platdata __initdata smdkv210_lcd0_pdata  = {
...
static struct platform_device __initdata *smdkv210_devices[]  = {
	&s3c_device_adc,
	&s3c_device_cfcon,
	&s3c_device_fb,
	&s3c_device_hsmmc0,
...
static struct i2c_board_info __initdata smdkv210_i2c_devs0[]  = {
	{ I2C_BOARD_INFO("24c08", 0x50), },     /* Samsung S524AD0XD1 */
	{ I2C_BOARD_INFO("wm8580", 0x1b), },
};

static struct i2c_board_info __initdata smdkv210_i2c_devs1[]  = {
	/* To Be Updated */
};

static struct i2c_board_info __initdata smdkv210_i2c_devs2[]  = {
	/* To Be Updated */
};
